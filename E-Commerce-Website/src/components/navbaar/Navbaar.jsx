...
const Navbaar = () => {
  const cart = useSelector(Alldata);
  const [open, setOpen] = useState(false);
  const { Mode, setMode, toggle } = useEcommerce();
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                    ...
                    <div className="flow-root">
                      {user?.user?.email === "arshi123@gmail.com" ? (
                        <Link
                          to={"/dashboard"}
                          className="-m-2 block p-2 font-medium text-gray-900"
                          style={{ color: Mode === "dark" ? "white" : "" }}
                  ...
                  <div className="border-t border-gray-200 px-4 py-6">
                    <a href="#" className="-m-2 flex items-center p-2">
                      ...
                      />
                      <span
                        className=" flex font-medium text-gray-900 items-center "
                        style={{ color: Mode === "dark" ? "white" : "" }}
                      >
                        <img className="h-10 w-10 rounded-full mr-2" src="https://cdn-icons-png.flaticon.com/128/10597/10597864.png" alt="indian flage" />
                        INDIA
                      </span>
              ...
              <div className="flex h-16 items-center">
                ...
                <div className="ml-auto flex items-center">
                  ...
                  <div className="hidden lg:ml-8 lg:flex">
                    <Link to="/signup">
                      <span
                        className="ml-3 block text-medium font-medium text-gray-600"
                        style={{ color: Mode === "dark" ? "white" : "" }}
                      >
                        signUp
                      </span>
